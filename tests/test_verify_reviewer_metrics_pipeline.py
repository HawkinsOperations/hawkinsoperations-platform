...
class ReviewerMetricsPipelineTests(unittest.TestCase):
    ...
    def test_state_metrics_match_source_artifacts(self) -> None:
        ...
        self.assertEqual(source_metrics["detection_activity_count"], 64)
        self.assertEqual(source_metrics["controlled_validation_fire_count"], 64)
        self.assertEqual(source_metrics["controlled_negative_test_count"], 72)
        self.assertEqual(source_metrics["validation_case_count"], 136)
        self.assertEqual(source_metrics["detection_activity_entry_count"], 13)
